...
print_params(a = 5) # Вывод значений  с разным количеством аргументов
print_params(5)
print_params(b = 'ноль', c = "три")
print_params(2, "столб", False)
print_params(a = 2, b = "столб", c = False)
print_params() # Вывод без аргументов

print_params(b = 25) # Вывод  print_params(b = 25)
print_params(c = [1,2,3]) # Вывод print_params(c = [1,2,3])
...
values_dict = {'a': 234, 'b' : False, 'c' : "const"}
