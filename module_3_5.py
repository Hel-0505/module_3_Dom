...
def get_multiplied_digits(number):
    ...
    str_number = str_number.replace("0", "1")                # Чтоб игнорировал нули
    if len(str_number) > 1:                                               # Если длина строки больше 1, рекурсивно вызываем функцию с оставшимися цифрами
        return first * get_multiplied_digits(int(str_number[1:]))
    else:                                                                # Если длина 1, возвращаем первую цифру
        return first
